// wwwroot/js/Department/handleChild.js
(function ($) {
    'use strict';
                ...
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <div class="form-floating">
                            <input name="SectionViewModels[{index}].Name"
                                       id="SectionViewModels_{index}__Name"
                                       class="form-control"
                                       placeholder="ชื่อแผนก"
                                       data-val="true"
                                       data-val-required="กรุณากรอกชื่อแผนก"
                                       data-val-maxlength="ชื่อแผนกต้องไม่เกิน 100 ตัวอักษร"
                                       data-val-maxlength-max="100"
                                       required>
                            <label for="SectionViewModels_{index}__Name">ชื่อแผนก</label>
                                <span class="text-danger small field-validation-valid"
                                      data-valmsg-for="SectionViewModels[{index}].Name"
